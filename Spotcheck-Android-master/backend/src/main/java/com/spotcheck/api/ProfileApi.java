...
/**
 * Defines the Profile API.
 */
@Api(name = "profileApi", version = "v1", namespace = @ApiNamespace(ownerDomain = "api.spotcheck.com", ownerName = "api.spotcheck.com"))
public class ProfileApi
{
     ...
     */
    @ApiMethod(name = "retrieveProfile", path = "retrieveProfile", httpMethod = HttpMethod.POST)
    public Account retrieveProfile(Profile accountForm)
    {
        return null;
    }
